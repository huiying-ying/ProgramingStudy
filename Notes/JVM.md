...
![image-20220914152502396](D:\Typora\Notes\imgs\JVM\image-20220914152502396.png)

其中JRE 包含了  JVM

## 2 JVM的体系结构

![image-20220914154648159](D:\Typora\Notes\imgs\JVM\image-20220914154648159.png)
...
![image-20220914162452401](D:\Typora\Notes\imgs\JVM\image-20220914162452401.png)
...
![image-20220914165602038](D:\Typora\Notes\imgs\JVM\image-20220914165602038.png)
...
![image-20220914165740937](D:\Typora\Notes\imgs\JVM\image-20220914165740937.png)

在 java1.2版本中，再次改进了安全机制，增加了 **代码签名** 。不论本地代码或是远程代码，都会按照用户的安全
策略设定，由类加载器加载到虚拟机中权限不同的运行空间，来实现差异化的代码执行权限控制。如下图所示
JDK1.2 安全模型

![image-20220914170214174](D:\Typora\Notes\imgs\JVM\image-20220914170214174.png)
...
![image-20220914173738471](D:\Typora\Notes\imgs\JVM\image-20220914173738471.png)
...
![image-20220915154919585](D:\Typora\Notes\imgs\JVM\image-20220915154919585.png)
...
**程序正在执行的方法一定在栈的顶部**（以不同的进程为例，下图展现程序当前执行的进程也一定在栈的顶部）
 ...
 ![image-20220915195456997](D:\Typora\Notes\imgs\JVM\image-20220915195456997.png)

理解栈、堆、方法区之间的关系

![image-20220915201722100](D:\Typora\Notes\imgs\JVM\image-20220915201722100.png)
...
![image-20220915202932770](D:\Typora\Notes\imgs\JVM\image-20220915202932770.png)
...
![image-20220917221619045](D:\Typora\Notes\imgs\JVM\image-20220917221619045.png)
...
![image-20220917223248739](D:\Typora\Notes\imgs\JVM\image-20220917223248739.png)
...
![image-20220918123709184](D:\Typora\Notes\imgs\JVM\image-20220918123709184.png)

每一次轻GC之后，To区是空的，From区收纳了所有从新生区和之前的From区（现在的To区）中活下来的，

![image-20220918124744041](D:\Typora\Notes\imgs\JVM\image-20220918124744041.png)
...
![image-20220918125308815](D:\Typora\Notes\imgs\JVM\image-20220918125308815.png)
...
![image-20220918125555190](D:\Typora\Notes\imgs\JVM\image-20220918125555190.png)
